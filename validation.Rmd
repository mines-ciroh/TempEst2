...
Requires an `Ecoregions.csv` file mapping gages to ecoregions.
...
ggsave("Figures/PerformanceBoxes_wBias.png", width=6.5, height=3, dpi=1200, bg="white")
```
